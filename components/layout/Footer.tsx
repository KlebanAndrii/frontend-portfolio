...
const Footer = () => {
  ...
  return (
    <footer className="border-t border-neutral-300 bg-white/30 py-5 backdrop-blur-md lg:py-10 dark:border-neutral-500 dark:bg-neutral-800/30">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-3">
          ...
          >
            ...
            <p className="mb-4 text-center text-sm text-gray-700 lg:text-left dark:text-gray-200">
          ...
          <motion.div {...fadeInUp(0.4)} className="flex flex-col items-center">
            ...
            <p className="mt-6 text-center text-sm font-medium text-gray-700 lg:text-left dark:text-gray-200">
