...
const Slides = () => {
  ...
  return (
    ...
    >
      <motion.header {...fadeInUp(0.05)} className="text-center mb-4 md:mb-8">
        <h2
          id="slides-title"
      ...
      <div className="relative">
        <AnimatePresence mode="wait">
          <motion.article
            ...
            {...fadeInRightExit()}
            className="mx-auto w-full rounded-2xl border border-neutral-300 bg-white/40 p-4 md:p-8 shadow-lg backdrop-blur-md dark:border-neutral-700 dark:bg-neutral-800/40 min-h-48"
          >
            <h3
              id={`slide-title-${currentIndex}`}
              className="text-lg md:text-xl font-bold mb-4 pb-2 border-b border-neutral-300 dark:border-neutral-600 text-gray-700 dark:text-gray-50"
            >
        ...
        <div className="flex justify-between mt-1 md:mt-2 text-xs text-gray-500 dark:text-gray-400">
          <span>
      ...
      <div className="flex flex-col md:flex-row justify-between gap-2 md:gap-4 mt-4 md:mt-6">
        <motion.button
          type="button"
        ...
        <div className="flex gap-2">
          <motion.button
            ...
            whileHover={{ scale: currentIndex === 0 ? 1 : 1.05 }}
            whileTap={{ scale: currentIndex === 0 ? 1 : 0.95 }}
            className={`flex-1 md:flex-none flex items-center justify-center gap-1 rounded-lg px-4 py-2 text-sm font-medium shadow-sm transition ${
              currentIndex === 0
                ? "bg-gray-100 text-gray-400 cursor-not-allowed dark:bg-neutral-800 dark:text-neutral-600"
